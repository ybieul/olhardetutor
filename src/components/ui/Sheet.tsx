...
/**
 * Panel that slides up from the bottom of the screen on mobile and
  ...
  return createPortal(
    <div className="fixed inset-0 z-modal flex items-end justify-center sm:items-center">
      ...
      <div
        ...
        tabIndex={-1}
        className="relative flex max-h-modal w-full max-w-sheet flex-col rounded-t-xl bg-white shadow-xl focus:outline-none sm:rounded-xl"
      >
